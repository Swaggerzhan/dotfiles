...
local package_path_str = "/root/.cache/nvim/packer_hererocks/2.1.1741730670/share/lua/5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1741730670/share/lua/5.1/?/init.lua;/root/.cache/nvim/packer_hererocks/2.1.1741730670/lib/luarocks/rocks-5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1741730670/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/root/.cache/nvim/packer_hererocks/2.1.1741730670/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ...
  ["animation.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/animation.nvim",
  ...
  ["blame.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/blame.nvim",
  ...
  ["lsp-inlayhints.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lsp-inlayhints.nvim",
  ...
  middleclass = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/middleclass",
  ...
  ["rainbow-delimiters.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/rainbow-delimiters.nvim",
    url = "https://github.com/HiPhish/rainbow-delimiters.nvim"
  },
  ["telescope-live-grep-args.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/telescope-live-grep-args.nvim",
  ...
  ["windows.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/windows.nvim",
